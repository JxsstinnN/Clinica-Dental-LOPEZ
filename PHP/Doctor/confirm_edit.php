...
if($_POST)
{
    ...
    $edit_medic=$con->prepare("UPDATE medico set Nombre='$Nombre',Apellido='$Apellido',Cedula='$Cedula',Genero='$Genero',Fecha_Nacimiento='$Fecha_Nac',Direccion='$Direccion',Telefono='$Telefono' where ID_Medico ='$id'");

...
<body id="body">
    ...
    <main>
        ...
        <div class="grid-container">
            <div class="grid-item"><span>Doctores</span></div>
            <div class="grid-item"><span>Pacientes</span></div>
            <div class="grid-item"><span>Nuevas Reservas</span></div>
            <div class="grid-item"><span>Sesiones hoy</span></div>
        </div>
